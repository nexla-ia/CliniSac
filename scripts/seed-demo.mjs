...
// Acesso: demo@clinisac.com.br / demo2026
...
const { data: userId, error: userErr } = await sb.rpc('create_user', {
  p_name: 'Equipe Demo', p_email: 'demo@clinisac.com.br', p_password: 'demo2026',
...
const appt = (nome, numero, off, h, m, pro, proc, status, pago) => ({
  ...
  created_by_email: 'demo@clinisac.com.br',
})
const appts = [
...
console.log('\n═══ CLÍNICA DEMO CRIADA ═══')
console.log('Login: demo@clinisac.com.br / demo2026')
