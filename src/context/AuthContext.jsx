...
export function AuthProvider({ children }) {
  ...
  // empresa com identidade "Suporte CliniSac" — ações ficam assinadas como suporte.
  async function masterEnter(companyId, masterEmail, displayName = 'Suporte CliniSac') {
